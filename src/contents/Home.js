...
import userpic from '../assets/resources/user.jpeg';
                    ...
                    <Col lg={7} className='order-2 order-sm-1'>
                        ...
                        <div className='typewriter2'>
                            <TypewriterEffect
                                ...
                                startDelay={1600}
                                cursorColor="black"
                                text="We are full stack developer. We are offering services to client in all latest technology."
                                typeSpeed={40}
                                hideCursorAfterText={true}
                            />
                        </div>
